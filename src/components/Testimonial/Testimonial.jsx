...
//               </div>
//             </div>
//             <p className="text-[16px] leading-7 mt-4 font-[400] " style={{ color: 'blue' }}>
...
//           <div className="py-[30px] px-5 rounded-3 ">
//             <div className="flex items-center gap-[13px]">
//               <img src={patientAvatar} alt="" style={{ width: '100px', height: '100px' }} />
//               <div>
//                 <h4 className="text-[18px] leading-[30px] font-semibold text-headingColor ">
//                   David Johnson
//                 </h4>
...
//               </div>
//             </div>
//             <p className="text-[16px] leading-7 mt-4 text-textColor font-[400] " style={{ color: 'blue', fontWeight: '500' }}>
...
//           <div className="py-[30px] px-5 rounded-3 ">
//             <div className="flex items-center gap-[13px]">
//               <img src={patientAvatar01} alt="" style={{ width: '100px', height: '100px' }} />
//               <div>
//                 <h4 className="text-[18px] leading-[30px] font-semibold text-headingColor ">
//                   Sara Miller
//                 </h4>
...
//           <div className="py-[30px] px-5 rounded-3 ">
//             <div className="flex items-center gap-[13px]">
//               <img src={patientAvatar02} alt="" style={{ width: '100px', height: '100px' }} />
...
//               </div>
//             </div>
//             <p className="text-[16px] leading-7 mt-4 mb-16 text-textColor font-[400] " style={{ color: 'blue', fontWeight: '500' }}>
